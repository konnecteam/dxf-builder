  ...
  return tuples.reduce((entity, tuple) => {
    ...
    switch (type) {
      ...
      case 34:
        ...
        break;
      case 15:
        entity.firstPointOnArc.x = value;
        break;
      case 25:
        entity.firstPointOnArc.y = value;
        break;
      case 35:
        entity.firstPointOnArc.z = value;
        break;
      case 16:
        entity.dimensionArc.x = value;
        break;
      case 26:
        entity.dimensionArc.y = value;
        break;
      case 36:
        entity.dimensionArc.z = value;
        break;
      case 42:
        entity.actualMeasurement = value;
        break;
      case 50:
      ...
      case 70: {
        ...
        if (dimType.ordinateType) { entity.ordinateType = true; }
        if (dimType.uniqueBlockReference) { entity.uniqueBlockReference = true; }
        if (dimType.userDefinedLocation) { entity.userDefinedLocation = true; }
